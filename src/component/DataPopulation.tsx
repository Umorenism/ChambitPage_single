...
const DataPopulation = () => {
  return (
    <div className="bg-white w-full flex items-center justify-center py-1 mt-2 shadow-md rounded-md  p-4">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center p-4 ">
        ...
        {/* Button */}
        <button className="px-4 py-2 bg-green-600 rounded-md text-white font-bold text-sm sm:text-base">
          0.60%
        </button>
      </div>
    </div>
